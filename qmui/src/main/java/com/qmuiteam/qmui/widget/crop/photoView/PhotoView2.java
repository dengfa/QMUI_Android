...
public class PhotoView2 extends AppCompatImageView {
    ...
    private void init() {
        attacher = new PhotoViewAttacher2(this);
    ...
    @SuppressWarnings("deprecation") private boolean onTouchEventInternal(MotionEvent event) {
    ...
    public void setChangeListener(MatrixWithListener matrixWithListener){
        attacher.setChangeListener(matrixWithListener);
    }
}
