...
fun View.updateShadowBackground(params: Params) {
...
fun generateRadius(value: Float = 24f): FloatArray {
...
private fun wrapDrawableToView(view: View, params: Params) {
...
class ShadowRoundRectDrawable constructor(val params: Params) : ShapeDrawable() {
    ...
    fun wrapLayerDrawable(): LayerDrawable {
        ...
        drawable.setLayerInset(0, desiredLeftPadding.toInt(), desiredTopPadding.toInt(), desiredRightPadding.toInt(), desiredBottomPadding.toInt())
        return drawable
    }

    fun applyLayerDrawableInset(index: Int, layerDrawable: LayerDrawable) {
        layerDrawable.setLayerInset(index, desiredLeftPadding.toInt(), desiredTopPadding.toInt(), desiredRightPadding.toInt(),
    ...
    fun applyParam(params: Params) {
        ...
        paint.setShadowLayer(correctShadowRadius, realDx, realDy, params.shadowColor)
    ...
    class Params(var outerRadii: FloatArray,
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other.shapeColor == shapeColor && other.shadowRadius == shadowRadius && other.dx == dx && other.dy == dy && other.shadowColor == shadowColor && other.excludeDx == excludeDx && other.outerRadii contentEquals outerRadii
        }
    }
}